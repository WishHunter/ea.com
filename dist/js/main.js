(function() {
	...
	$('.menu_mobile_link').on('click', function(e) {
		e.preventDefault();
		$('.main_menu').fadeOut();
	...
	$('.menu_mobile_close').on('click', function(e) {
		e.preventDefault();
		$('.main_menu').fadeIn();
	...
	$('.open_hover_block').on('click', function(e) {
		e.preventDefault();
		$(this).parent('.game_block').addClass('active');
		return false;
	});
	$('.close_hover_block').on('click', function(e) {
		e.preventDefault();
		$(this).parent('.game_block').removeClass('active');
		return false;
	});
}())
